...
function SignUp({ switchToLogin }) {
    return (
        <div className="flex flex-col w-full lg:w-5/12 h-full px-6 py-8 lg:p-10">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3.5">Sign Up</h1>
            <h2 className="text-sm md:text-base mt-2 mb-8">Create a new account</h2>
            ...
            <div className="flex justify-center mt-5 w-full">
                <LargeButton label="Sign up" width="100%" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row w-full sm:w-4/5 justify-between items-center gap-4 mx-auto">
                ...
                <GhostButton label="Login" onClick={switchToLogin} />
            </div>
        </div>
    )
}
